...
class MainAdapter4 (var mContext: Context, var yemeklerListesi:List<DataClass>)
    : RecyclerView.Adapter<MainAdapter4.CardTasarimTutucu>() {

    inner class CardTasarimTutucu(var tasarim: CardTasarim2Binding) : RecyclerView.ViewHolder(tasarim.root)
