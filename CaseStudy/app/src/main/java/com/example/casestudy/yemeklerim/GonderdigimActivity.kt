...
import com.example.casestudy.databinding.ActivityGonderdigimBinding
...
class GonderdigimActivity : AppCompatActivity() {

    private lateinit var binding : ActivityGonderdigimBinding
    private lateinit var database: DatabaseReference
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityGonderdigimBinding.inflate(layoutInflater)
        ...
        database.child("gonderdigim").addListenerForSingleValueEvent(object : ValueEventListener {
